/* FILE: padreFiglioComunicanti.c: Padre crea un figlio e il figlio si comporta come produttore e il padre come consumatore */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <fcntl.h>
...
{   
	...
	int fd;
	close (piped [0]); 	/* il figlio CHIUDE il lato di lettura: QUINDI SI CLASSIFICA COME SCRITTORE DELLA PIPE */
...
/* padre */
close (piped [1]); /* il padre CHIUDE il lato di scrittura: QUINDI SI CLASSIFICA COME LETTORE DELLA PIPE */		
