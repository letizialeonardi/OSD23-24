 ...
 * Entrambi i thread eseguono in un ciclo finito di iterazioni: il 'generatore' di atomi di idrogeno esegue 2*NTIMES iterazioni, mentre il 'generatore' di atomi di ossigeno solo NTIMES iterazioni; la fase di generazione di ogni atomo viene simulata con una sleep(2).
